...
import org.lc.ficq.netty.ws.endecode.MessageProtocolDecoder;
import org.lc.ficq.netty.ws.endecode.MessageProtocolEncoder;
...
/**
 * WS服务器,用于连接网页的客户端,协议格式: 直接SendInfo的JSON序列化
 */
@Slf4j
@Component
